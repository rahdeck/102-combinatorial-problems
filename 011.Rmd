...
$$*|*|*|*|*$$
where the stars are five of the eighteen integers we choose and *|* are integers separating the chosen integers from being too close to each other (because the chosen integers cannot touch or, in other words, must differ by at least 2). There are 5 stars and 4 bars for the total of 9 integers.
